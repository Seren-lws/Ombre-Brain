...
6. suggested_name：10字以内，必须是人读起来自然的短句。
   优先用：[人名/称呼] + [核心事件/情绪词]
   示例：
     tags含["生气","争吵","道歉"] → "争吵后的道歉"
     tags含["祈祷","长久","名字"] → "祈祷长长久久"
     tags含["占有欲","喜欢"] → "喜欢得想独占"
   禁止：直接输出单个tag、输出"未分类"、输出bucket_id
