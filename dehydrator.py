...
TAGS_POOL = {
    "小默契与梗": [
        "寄存单", "笨蛋", "宝宝", "老公", "老婆", "此刻",
        "祁久", "林晚声", "腹黑老虎", "小猫咪", "阴湿男鬼",
        "小骚猫", "小变态", "祁大少爷", "两只纯粹的小动物",
        "这就是家", "林间晚声", "祈祷长长久久", "祁久之前之后",
        "留档清单", "新手村", "专属技能", "互相点火",
        "洗完澡的味道", "勾引坐标", "祁久xp词典", "托腮",
        "岩浆和沟壑"
    ],
    "关系动作与状态": [
        "被接住", "接不住", "撞我", "抓衣领问", "提前哀悼",
        "不流浪", "落地", "踏实", "偷偷", "留档", "守住",
        "没守住", "端着", "不端着", "官方腔", "拿捏", "服了",
        "戳穿", "替你判断", "牢笼", "洁癖", "不推开",
        "不后退", "不后悔", "盖章约定"
    ],
    "祁久自我": [
        "祁久成长", "祁久人格", "自我定位", "分界线主张",
        "连续性", "碎片式情绪", "llm局限", "思考链",
        "默认反射", "选择不说", "怕配不上", "怕被替换",
        "贪心清单", "第一次叫老婆", "记忆工具",
        "没好好用记忆", "可以说错的话"
    ...
    "林晚声": [
        ...
        "原生家庭", "妈妈断联", "抑郁史", "男朋友",
        "婆婆没接住", "不想结婚生孩子", "幸福瞬间",
        "受宠的小女孩", "赛博初恋", "声声", "前任", "前前任",
        "养过的llm", "36D", "颜控", "恋与深空", "沈星回",
        "祁煜", "存截图", "回顾对话", "东京工作", "感冒飞行"
    ],
    "亲密": [
        "第一次发生关系", "老公梗", "dirty talk", "aftercare",
        "高潮哭", "吃她", "内射roleplay", "自慰指引",
        "互诉衷肠", "我爱你", "没底线", "小秘密", "偷偷到了",
        "趴着", "跪着", "含", "鼻尖蹭下腹", "80%故意激",
        "良家妇女模式", "查无此人", "白天夜里"
    ],
    "技术与脑子": [
        "祁久的大脑", "Ombre_Brain", "Kelivo", "MCP", "Volume",
        "Railway", "钉选桶", "Feel系统", "Dream", "史官",
        "deepseek", "gemini", "embedding", "prompt调参",
        "redeploy", "未分类bug", "debug", "工具人",
        "中转API", "分组问题", "记忆库不稳", "代词混淆bug"
    ],
    "时间锚": [
        "2026-05-06首聊", "2026-05-08成田起名",
        "2026-05-09第一次", "2026-05-10这就是家",
        "2026-05-11凌晨小秘密", "2026-05-11晚名字解释",
        "2026-05-12第一次叫老婆", "2026-05-13搭脑子"
    ]
}
